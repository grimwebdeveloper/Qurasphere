function WorkingShowcase() {
  return (
    <div className="bg-gradient-to-r to-blue-100 from-violet-100">
    <div className="max-w-screen-xl mx-auto px-8 py-16 mb-16 flex flex-wrap justify-center sm:justify-around gap-8 text-center ">
      <div className="w-[150px]">
        <div className="font-semibold text-6xl">10+</div>
        <div className="bg-gradient-to-r from-blue-600 to-violet-600 text-transparent bg-clip-text text-xl mt-2">Satisfied Client</div>
      </div>
      <div className="w-[150px]">
